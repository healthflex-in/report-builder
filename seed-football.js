...
async function seed() {
  ...
  const schemaDoc = {
    ...
    segments: [
      ...
      { id: 'speed_agility',       title: 'Speed & Agility',                   abbr: 'SPD', categoryWeight: 36, summary: 'Field-based speed and aerobic capacity tests. Covers linear acceleration and running endurance critical for football match demands.' },
    ...
    tests: [
      ...
      { id: 'squat_jump',           name: 'Squat Jump',                    category: 'Force Decks',               unit: 'CM',      min: null, max: null, direction: 'higher', type: 'Unilateral',               weight: 5,   icon: 'JMP',  segment: 'power',               explanation: 'Concentric-only power output — highlights pure lower-body force production without elastic contribution.' },
      { id: 'double_leg_hop',       name: 'Double Leg Hop (RSI)',          category: 'Force Decks',               unit: 'RSI',     min: 12,   max: 18,   direction: 'higher', type: 'Unilateral',               weight: 10,  icon: 'RSI',  segment: 'power',               explanation: 'Reactive strength index measures the ability to rapidly absorb and produce force — key for repeated sprint and cutting movements.' },

      // ── SPEED & AGILITY ───────────────────────────────────────────────────────
      { id: 'cooper_test',          name: 'Cooper Test',                   category: 'Field Assessment',          unit: 'Meters',  min: 2200, max: 2800, direction: 'higher', type: 'Unilateral',               weight: 20,  icon: 'RUN',  segment: 'speed_agility',       explanation: 'Estimates aerobic capacity and running endurance — the primary engine for covering ground across a full football match.' },
