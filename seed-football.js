...
async function seed() {
  ...
  const schemaDoc = {
    ...
    tests: [
      ...
      { id: 'squat_jump',           name: 'Single Leg Jump',               category: 'Force Decks',               unit: 'CM',      min: null, max: null, direction: 'higher', type: 'Bilateral - with Asym',    weight: 5,   icon: 'JMP',  segment: 'power',               explanation: 'Single leg jump height measured on each leg — highlights unilateral power and inter-limb asymmetry critical for sprinting and cutting.' },
