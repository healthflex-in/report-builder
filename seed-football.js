...
async function seed() {
  ...
  const schemaDoc = {
    ...
    tests: [
      ...
      { id: 'squat_jump',           name: 'RFD',                           category: 'Force Decks',               unit: 'N/S',     min: 1200, max: 2500, direction: 'higher', type: 'Unilateral',               weight: 5,   icon: 'RFD',  segment: 'power',               explanation: 'Rate of Force Development — how quickly force can be produced. Key for explosive actions like sprinting, jumping and change of direction.' },
      { id: 'double_leg_hop',       name: 'Double Leg Hop - RSI',          category: 'Force Decks',               unit: 'M/S',     min: 12,   max: 18,   direction: 'higher', type: 'Unilateral',               weight: 10,  icon: 'RSI',  segment: 'power',               explanation: 'Reactive strength index measures the ability to rapidly absorb and produce force — key for repeated sprint and cutting movements.' },
